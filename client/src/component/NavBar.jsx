      ...
      <Container maxWidth='xl'>
        ...
        >
          <Grid container wrap='nowrap' direction={'row'} justifyContent={'space-between'} alignItems={'center'} spacing={2}>
            ...
            <Grid container item direction={'row'} alignItems={'center'} justifyContent={'flex-end'} spacing={4}>
              <Grid item xs='auto' style={{textAlign: "center"}}>
                <Button color={useLocation().pathname === '/player' ? 'success' : 'inherit'} style={{textTransform: 'none', textAlign: 'center'}}>
