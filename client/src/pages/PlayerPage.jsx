...
export default function PlayerPage() {
  ...
  // use effect
  useEffect(() => {
    fetch(`http://${SERVER_HOST}:${SERVER_PORT}/api/player`) // send get request to /player route on server
  ...
  return (
    <>
      ...
      <SearchBar defaultValue={searchInput} placeholder='Name' handleSearch={handleSearch}/>
